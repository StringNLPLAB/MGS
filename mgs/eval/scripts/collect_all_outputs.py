...
MODELS = [
    ...
    # "/home/work/checkpoints/stricter-format-grpo-rlmt+rlvr-zero-rl-qwen-2.5-7b/global_step_266/actor/huggingface",
    # "/home/work/models/open-thoughts/OpenThinker3-7B"
    "/root/paddlejob/workspace/env_run/output/work/checkpoints/strict_8192_overlong_2048-rlvr-zero-rl-rlvr-zero-rl-rlmt-based-Qwen2.5-7B-dapo/global_step_266/actor/huggingface"
    # "/home/work/models/princeton-nlp/zero__base__think__Qwen2.5-7B"
    # "/home/work/models/Qwen/Qwen-2.5-7B-Prompted"
    # "/home/work/checkpoints/dapo-strict-wo-dynamic-template-rlvr-zero-rl-qwen-2.5-7b/global_step_266/actor/huggingface"
]
...
def find_score_file(outputs_dir, benchmark, model):
    ...
    relative_model = model.lstrip("/")
    model_dir = Path(outputs_dir) / f"{benchmark}-compare" / relative_model
